...
- [x] Implement `service bring-up mempool`
- [x] Strengthen `service status mempool` with HTTP readiness and `degraded`
- [x] Improve text/json operator feedback for bring-up
